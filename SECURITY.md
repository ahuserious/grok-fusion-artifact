...
Only environment-variable names such as `XAI_API_KEY` appear. The verifier rejects common xAI/OpenAI/GitHub/private-key shapes, long base64url-like token strings, bearer values, and macOS user/temp paths.
